...
[![Coco v0.21.3-36](https://img.shields.io/badge/Coco%20AI-v0.21.3-36-blue)](https://github.com/liyuheng200408-pixel/coco-real-estate/releases/tag/v0.21.3-36)

> 🏷️ **当前版本：v0.21.3-36**（官方 Hermes v0.21.3 定制版） · [GitHub Release](https://github.com/liyuheng200408-pixel/coco-real-estate/releases/tag/v0.21.3-36)
...
```bash
coco version     # 输出形如：Coco v0.21.3-36（官方 Hermes 0.21.3 定制版）
