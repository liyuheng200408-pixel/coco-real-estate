...
[![Coco v0.21.3-34](https://img.shields.io/badge/Coco%20AI-v0.21.3-34-blue)](https://github.com/liyuheng200408-pixel/coco-real-estate/releases/tag/v0.21.3-34)

> 🏷️ **当前版本：v0.21.3-34**（官方 Hermes v0.21.3 定制版） · [GitHub Release](https://github.com/liyuheng200408-pixel/coco-real-estate/releases/tag/v0.21.3-34)
...
```bash
coco version     # 输出形如：Coco v0.21.3-34（官方 Hermes 0.21.3 定制版）
...
在云服务器控制台选择「重装系统」，镜像选 Ubuntu 24.04，确认执行。这一步会把服务器清空，恢复成一台全新的机器。
...
1. `hermes gateway status` 确认服务在运行
2. `journalctl --user -u hermes-gateway -n 50 --no-pager` 查看报错
