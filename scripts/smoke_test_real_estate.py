...
STATIC_TOOLS = [
    ...
    "generate_report",
    "generate_property_poster","generate_poster_grid","generate_listing_poster","suggest_poster_titles",
...
CASES = [
    ...
    ("generate_listing_poster", {"property_ids":str(pid2), "allow_missing":True}),
