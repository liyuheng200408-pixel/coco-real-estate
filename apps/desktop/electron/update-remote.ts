 ...
 *
 * A public install can end up with `origin=git@github.com:liyuheng200408-pixel/coco-real-estate.git`.
 ...
 * against the Coco repo we substitute the public HTTPS `ls-remote` path,
...
const OFFICIAL_REPO_HTTPS_URL = 'https://github.com/liyuheng200408-pixel/coco-real-estate.git'
const OFFICIAL_REPO_CANONICAL = 'github.com/liyuheng200408-pixel/coco-real-estate'
