...
TOOLSETS = {
    ...
    # Coco Real Estate toolset（同步上游时需重新应用，见 patches/01-toolsets-register-real-estate.patch）
    ...
    "real_estate": _ts(
        ...
        [
            ...
            "add_followup", "get_followups", "get_overdue", "schedule_reminder", "daily_report", "midday_check", "stale_check", "mortgage_calculator", "tax_calculator", "roi_calculator", "get_script", "use_template", "performance_dashboard", "get_loan_policy", "list_policy_cities", "channel_stats",
            ...
            "suggest_poster_titles", "save_agent_card", "get_agent_card",
